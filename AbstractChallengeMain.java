...
public class AbstractChallengeMain {
    ...
    public static void main(String[] args) {
        ...
        String stringData = "5 7 8 3 2 1 6 7 4 5 9 6";
...
//        GroceryList peeps = new GroceryList();
//
//        String stringData = "minced beef, apples, onions, cumin, paprika, ginseng, black pepper, " +
//                "bell peppers (green and red), olive oil, semi-salted butter, TP, tissues, kanga steaks, handscream, breakfast stuff, tp, milk";
//
//        String[] data = stringData.split(", ");
//
//        for(String s : data) {
